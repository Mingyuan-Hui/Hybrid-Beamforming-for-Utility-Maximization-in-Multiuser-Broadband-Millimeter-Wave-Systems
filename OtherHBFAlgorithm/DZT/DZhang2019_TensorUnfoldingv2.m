function [ F, W] = DZhang2019_TensorUnfoldingv2( H, Ns, sigma2, Pt, rho)
 %% Reference
 % the Matlab codes for the algorithms proposed in the paper D. Zhang, Y. Wang, X. Li, and W. Xiang, "Hybrid beamforming for downlink multiuser millimetre wave MIMO-OFDM systems," IET Commun., vol. 13, no. 11, pp. 1557–1564, Jul. 2019.
