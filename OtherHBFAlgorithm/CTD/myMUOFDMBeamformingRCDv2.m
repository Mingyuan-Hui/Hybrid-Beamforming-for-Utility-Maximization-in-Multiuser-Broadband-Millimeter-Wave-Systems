function [ F, W] = myMUOFDMBeamformingRCDv2( H, Ns, sigma2, Pt, rho)
 %% Reference
 % the Matlab codes for the algorithms proposed in the paper "Constrained Tensor Decomposition-Based Hybrid Beamforming for Mmwave Massive MIMO-OFDM Communication Systems", published on IEEE Transactions on Vehicular Technology. The original paper can be found at: https://ieeexplore.ieee.org/document/9419762
 % https://github.com/zilligm/constrained_tensor_decomposition_hybrid_beamforming
if length(size(H)) == 4
        [Nr,Nt,M,K] = size(H);
    else
